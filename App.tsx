...
const App: React.FC = () => {
  ...
  const addProduct = async (product: Product) => {
    // تنظيف الكائن من القيم غير المعرفة (undefined) لتجنب أخطاء الأعمدة المفقودة
  ...
  const addOrder = async (order: Order) => {
    // تنظيف الكائن من القيم غير المعرفة (undefined)
  ...
  const addSpecialRequest = async (req: SpecialRequest) => {
    // تنظيف الكائن من القيم غير المعرفة (undefined)
